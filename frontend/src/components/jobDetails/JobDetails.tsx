...
//       // Setting formDetails to chrome storage so when the user returns to this page, all the details are saved
...
//     console.log("Value currently is " + result.formDetails);
